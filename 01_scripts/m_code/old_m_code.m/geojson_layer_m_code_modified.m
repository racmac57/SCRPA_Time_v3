...
let
    ...
    #"Added Time_Of_Day_Category" = Table.AddColumn(
                                    ...
                                    each let h = [callhour] in
                                        ...
                                        else if h < 4 then "00:00–03:59 Early Morning"
                                        else if h < 8 then "04:00–07:59 Morning"
                                        else if h < 12 then "08:00–11:59 Morning Peak"
                                        else if h < 16 then "12:00–15:59 Afternoon"
                                        else if h < 20 then "16:00–19:59 Evening Peak"
