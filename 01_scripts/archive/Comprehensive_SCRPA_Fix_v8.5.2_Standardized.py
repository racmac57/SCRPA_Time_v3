...
class ComprehensiveSCRPAFixV8_5:
    ...
    def process_rms_data(self, rms_file):
        ...
        # Parse and chain-fill dates using actual normalized column names
        d1 = pd.to_datetime(rms_df["incident_date"], errors="coerce")
        d2 = pd.to_datetime(rms_df["incident_date_between"], errors="coerce")  
        d3 = pd.to_datetime(rms_df["report_date"], errors="coerce")
